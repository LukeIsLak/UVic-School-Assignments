...
public class RefBasedBinaryTree implements BinaryTree {
	...
	protected int height(TreeNode t) {
		...
		int leftTree = height(t.getLeft());
		int rightTree = height(t.getRight());
	...
	public void inOrderRes(TreeNode t) {
		if (t == null) {
			return;
		}

		inOrderRes(t.getLeft());
		System.out.println(t.getValue());
		inOrderRes(t.getRight());
	}
	...
	private void preOrderRes(TreeNode t) {
		if (t == null) {
			return;
		}

		System.out.println(t.getValue());
		preOrderRes(t.getLeft());
		preOrderRes(t.getRight());
	}
	...
	private void postOrderRes(TreeNode t) {
		if (t == null) {
			return;
		}

		postOrderRes(t.getLeft());
		postOrderRes(t.getRight());
		System.out.println(t.getValue());
	}
