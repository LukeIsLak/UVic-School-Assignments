...
public class A1Tester {
	...
	public static void testGreatestCommonDenominator() {
		...
		result = A1Exercises.greatestCommonDenominator(144, 12);
		expected = 12;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		result = A1Exercises.greatestCommonDenominator(61, 5);
		expected = 1;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
	...
	public static void printArrayExample() {
		...
		System.out.println("Expected: {2,3,2,0}");
		A1Exercises.printArray(array3);
		System.out.println("Expected: {-1,2,4,1,3}");
	}
	...
	public static void testCountMatches() {
		...
		System.out.println("Testing countMatches(arr0, 1)");
		result = A1Exercises.countMatches(arr0, 1);
		expected = 0;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
		...
		System.out.println("Testing countMatches(arr3, 4)");
		result = A1Exercises.countMatches(arr3, 4);
		expected = 3;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
