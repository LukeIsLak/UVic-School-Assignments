public class A5Tester {
	...
	public static void testTotalBooks() {
		...
		LinkedBookList list8 = new LinkedBookList();
		...
		result = list6.totalBooks();
		expected = 0;
		displayResults(result==expected, "totalBooks in list6");

		result = list7.totalBooks();
		expected = 4;
		displayResults(result==expected, "totalBooks in list7");

		result = list8.totalBooks();
		expected = 2;
		displayResults(result==expected, "totalBooks in list8");
	...
	public static void testTotalPages() {
		...
		Book[] books4 = {b1, b2, b3, b4, b5, b6, b7};
		list4.buildFromArray(books4);
		Book[] books6 = {b1, b1, b3, b4, b4, b3, b1};
		list6.buildFromArray(books6);
		...
		result = list6.totalPages();
		expected = 432+432+374+390+390+374+432;
		displayResults(result==expected, "totalPages in list6");
