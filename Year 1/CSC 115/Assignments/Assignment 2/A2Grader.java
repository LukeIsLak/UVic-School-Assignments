public class A2Grader {
	...
	public static void testIsNamed() {
		...
		try {
			...
			displayResults(false, "in1 is named " + toFind);
		}
		...
		try {
			...
			displayResults(false, "in2 is named " + toFind);
		}
		...
		try {
			...
			displayResults(false, "in3 is named " + toFind);
		}
		...
		try {
			...
			displayResults(false, "a4a is named " + toFind);
		}
	...
	public static void testIsShorterThan() {
		...
		try {
			...
			displayResults(false, "p1 is shorter than " + timeLimit + " minutes");
		}
		...
		try {
			...
			displayResults(false, "p2 is shorter than " + timeLimit + " minutes");
		}
		...
		try {
			...
			displayResults(result==expected, "p3 is shorter than " + timeLimit + " minutes");
	                ...
	                displayResults(false, "p3 is shorter than " + timeLimit + " minutes");
	        }
		...
		try {
			...
			displayResults(false, "p4 is shorter than " + timeLimit + " minutes");
		}
	...
	public static void testAverageFollowers() {
		...
		try {
			...
			displayResults(false, "average age of cast in p1");
		}
		...
		try {
			...
			displayResults(Math.abs(result-expected)<THRESHOLD, "average age of cast in p2");
	                ...
	                displayResults(false, "average age of cast in p2");
	        }
		...
		try {
			...
			//System.out.println("\nExpected: "+expected+". Result returned: "+result);
			displayResults(Math.abs(result-expected)<THRESHOLD, "average age of cast in p3");
	        } catch (Exception e) {
	                displayResults(false, "average age of cast in p3");
	        }
		...
		try {
			...
			//System.out.println("\nExpected: "+expected+". Result returned: "+result);
			displayResults(Math.abs(result-expected)<THRESHOLD, "average age of cast in p4");
	        } catch (Exception e) {
	                displayResults(false, "average age of cast in p4");
	        }
	}
	...
	public static void testHasHost() {
		...
		try {
			...
			displayResults(false, "m1 has "+in1+" as a host");
		}
		...
		try {
			...
			displayResults(result==expected, "m1 has "+in2+" as a host");
	                ...
	                displayResults(false, "m1 has "+in2+" as a host");
	        }
		...
		try {
			...
			displayResults(false, "m1 has "+in3+" as a host");
		}
		...
		try {
			result = p2.hasHost(in6);
			expected = true;
			//System.out.println("\nExpected: "+expected+". Result returned: "+result);
			displayResults(result==expected, "m1 has "+in4a+" as a host");
		} catch (Exception e) {
			displayResults(false, "m1 has "+in4a+" as a host");
		}

		try {
			result = p2.hasHost(in7);
			expected = false;
			//System.out.println("\nExpected: "+expected+". Result returned: "+result);
			displayResults(result==expected, "m1 has "+in7+" as a host");
		} catch (Exception e) {
			displayResults(false, "m1 has "+in7+" as a host");
		}
	}
	...
	public static void testHighestFollowers() {
		...
		try {
			...
			displayResults(false, "highest followers between "+in1+" and "+in2);
		}

		// add tests until you are sure your implementation works correctly

		try {
			result = A2Exercises.highestFollowers(in1, in1);
			expected = 17000000;
			//System.out.println("\nExpected: "+expected+". Result returned: "+result);
			displayResults(result==expected, "highest followers between "+in1+" and "+in2);
		} catch (Exception e) {
		...
		try {
			result = A2Exercises.highestFollowers(in1, in3);
			expected = 136000000;
			//System.out.println("\nExpected: "+expected+". Result returned: "+result);
			displayResults(result==expected, "highest followers between "+in1+" and "+in3);
		} catch (Exception e) {
			displayResults(false, "highest followers between "+in1+" and "+in3);
		}

		try {
			result = A2Exercises.highestFollowers(in4a, in5);
			expected = 94000000;
			//System.out.println("\nExpected: "+expected+". Result returned: "+result);
			displayResults(result==expected, "highest followers between "+in4a+" and "+in5);
		} catch (Exception e) {
			displayResults(false, "highest followers between "+in4a+" and "+in5);
		}
	}
	...
	public static void testMostFollowers() {
		...
		try {
			...
			displayResults(false, "most followers in array1");
		}
		...
		try {
			...
			displayResults(result.equals(expected), "most followers in array2");
	                ...
	                displayResults(false, "most followers in array2");
	        }

		// add tests until you are sure your implementation works correctly

		try {
			result = A2Exercises.mostFollowers(array3);
			expected = in3;
			//System.out.println("\nExpected: "+expected+". Result returned: "+result);
			displayResults(result.equals(expected), "most followers in array3");
	        } catch (Exception e) {
	                displayResults(false, "most followers in array3");
	        }
		...
		try {
			...
			displayResults(result.equals(expected), "most followers in array4");
	                ...
	                displayResults(false, "most followers in array4");
	        }
		...
		try {
			...
			displayResults(result.equals(expected), "most followers in array5");
	                ...
	                displayResults(false, "most followers in array5");
	        }
	}
	...
	public static void testNumberShorterThan() {
		...
		try {
			...
			displayResults(false, "array0 podcasts shorter than "+timeLimit+" minutes");
		}
		...
		try {
			result = A2Exercises.numberShorterThan(array1, timeLimit);
	        	...
	        	displayResults(false, "array1 podcasts shorter than "+timeLimit+" minutes");
	        }
		...
		try {
			...
			displayResults(result == expected, "array2 podcasts shorter than "+timeLimit+" minutes");
	                ...
	                displayResults(false, "array2 podcasts shorter than "+timeLimit+" minutes");
	        }
	...
	public static void testNumberWithInfluencer() {
		...
		try {
			...
			displayResults(false, "array0 podcasts with "+toFind+" as a host");
		}
		...
		try {
			...
			displayResults(result == expected, "array1 podcasts with "+toFind+" as a host");
	                ...
	                displayResults(false, "array1 podcasts with "+toFind+" as a host");
	        }
		...
		try {
			...
			displayResults(result == expected, "array2 podcasts with "+toFind+" as a host");
	                ...
	                displayResults(false, "array2 podcasts with "+toFind+" as a host");
	        }
	...
	public static void testHighestAverageFollowers() {
		...
		try {
			...
			displayResults(false, "highest average followers of podcast hosts in array1");
		}
		...
		try {
			...
			displayResults(result.equals(expected), "highest average followers of podcast hosts in array2");
	                ...
	                displayResults(false, "highest average followers of podcast hosts in array2");
	        }
		...
		try {
			...
			displayResults(result.equals(expected), "highest average followers of podcast hosts in array3");
	                ...
	                displayResults(false, "highest average followers of podcast hosts in array3");
	        }
